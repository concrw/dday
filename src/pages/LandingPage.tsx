...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-20 gap-6 text-center px-4">
      ...
      >
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#1a9aaa" strokeWidth="1.5">
      ...
      <Link
        to="/create"
        className="inline-flex items-center justify-center min-h-12 px-8 rounded-xl text-base font-semibold text-white transition-all duration-200 hover:scale-105 w-full max-w-xs"
    ...
    <div className="min-h-screen" style={{ background: '#f0f0f0' }}>
      ...
      >
        <div className="max-w-5xl mx-auto text-center flex flex-col items-center gap-4">
          ...
          <Link
            to="/create"
            className="inline-flex items-center justify-center min-h-12 px-8 rounded-xl text-base font-semibold transition-all duration-200 hover:scale-105 mt-2"
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        ...
        {error && (
          <p className="text-center py-8" style={{ color: '#e74c3c' }}>
