...
result.json schema: {"schema_version":"execution_result_v1","task_id":"f7a3a4da-f6ca-4f57-8b4a-d2c42abf3fd6","status":"SUCCESS|FAILED","summary":"min 20 chars","changed_files":[],"artifacts":[],"tests":{"ran":false,"passed":false},"approval_flags":[],"issues":[],"next_actions":[]}
